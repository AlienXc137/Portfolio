  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "azharahmad0704@gmail.com",
      href: "mailto:azharahmad0704@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 7217798407",
      href: "tel:+917217798407"
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  const socialLinks = [
    {
      icon: FaGithub,
      label: "GitHub",
      href: "https://github.com/AlienXc137",
      color: "hover:text-gray-900 dark:hover:text-gray-100"
    },
    {
      icon: FaLinkedin,
      label: "LinkedIn", 
      href: "https://linkedin.com/in/azhar-ahmad-9999a8192",
      color: "hover:text-blue-600"
    },
    {
      icon: FaXTwitter,
      label: "Twitter",
      href: "https://x.com/Azhar_Ahmad_",
